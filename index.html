...
<div class="container mt-5 position-relative">
   <br> <img src="images/top-ribbon.png" class="img-fluid position-absolute start-50 translate-middle px-3" style="">
    <div class="text-center px-4 py-5 shadow rounded-15 bg-white"> <a href="https://cerbientscarrow.com/click" target="_blank" rel="nofollow"><br><br>
      <span class="mt-4"><img src="images/actnow.png" class="img-fluid mx-auto d-block"></span><br><img src="images/11.png" width="280" class="img-fluid mx-auto d-block"></a>
				<div class="mt-4"><img src="images/bottom-ribbon.png" class="img-fluid mx-auto d-block"></div>
				<div class="mt-5"><a href="https://cerbientscarrow.com/click" rel="nofollow" role="button" class="btn btn-order pulse font-fjalla"><strong>Check Availability Now <em class="ms-2 ms-sm-3 bi bi-arrow-right-circle-fill"></em></strong></a><br><img src="images/arrows.png" width="160" height="auto" alt=""/><span class="mt-4"></span><strong><br><br>
				</strong></div>
</div>
